initial_time=13; final_time=-10; delta_x=-0.01; time=10:delta_x:final_time;
delta_theta=0.001*pi; final_theta=3*pi-delta_theta; domain=0:delta_theta:final_theta; domain=domain[2:end-1];
